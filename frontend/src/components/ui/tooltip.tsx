...
interface TooltipTriggerProps extends ComponentProps<typeof TooltipPrimitive.Trigger> {
  asChild?: boolean
}
  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "pointer-events-auto bg-primary text-primary-foreground animate-in fade-in-0 zoom-in-95 " +
